...
class MessageForm extends React.Component{
  ...
  IndexFormAddError(string){
    ...
    case 'like-dislike': 
                  ...
                  document.querySelector(".customtooltip.like-dislike").classList.add("error");
                  break;
    case 'textarea':  
                  document.querySelector(".customtooltip.textarea").classList.add("error");
  ...
  IndexFormRemoveError(string){
    ...
    case 'like-dislike': 
                  ...
                  document.querySelector(".customtooltip.like-dislike").classList.remove("error");
                  break;
    case 'textarea':  
                  document.querySelector(".customtooltip.textarea").classList.remove("error");
