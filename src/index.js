...
class MyMessageForm extends React.Component {
  ...
  checkLike(e) {
    e.preventDefault();
    this.setState({ isLiked: true, likeBtnColour: "midnightblue" ,dislikeBtnColour: "#d3d3d3"});
  ...
  checkDislike(e) {
    e.preventDefault();
    this.setState({ isLiked: false, likeBtnColour: "#d3d3d3" ,dislikeBtnColour: "red"});
    if(this.state.notificationText === 'Deneyimin pozitif mi negatif mi?'){
      this.setState({notificationText: ''});
    }
  }
                ...
                <svg className="test-speak" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                  ...
                  <g transform="matrix(1.25 0 0 -1.25 0 45)">
                    <g>
                      <g>
                        <g>
                          <path className="speak-voice" style={{fill: "#FFAC33"}} d="M395.225-224.062c0.034-6.292-5.04-11.401-11.355-11.412l-56.889-0.148
                          ...
                          <path className="speak-voice" style={{fill: "#FFAC33"}} d="M377.157-161.609c2.708-5.678,0.284-12.459-5.404-15.167l-51.382-24.405
                          ...
                          <path className="speak-voice" style={{fill: "#FFAC33"}} d="M377.498-286.617c2.662,5.7,0.228,12.47-5.461,15.132l-51.519,24.144
                        ...
                        <path style={{fill:"#292F33"}} d="M305.818-129.865c-16.156,4.767-30.64,17.601-35.681,25.6
          ...
          <div className="container-right-half">
            ...
            <div className="container-main">
              ...
              <div className="main-form-header">
                <span className="container-header-image" aria-hidden="true">
                  <a className="image-link-landing" 
                    ...
                    aria-label="Homepage">
                      <svg
                        ...
                        sodipodiDocname="thoughtbubble.svg">
                        <defs
                          id="defs2" />
                        <sodipodiNamedview
                          id="base"
                          ...
                          inkscapeZoom="0.35"
                          inkscapeCx="248.38285"
                          inkscapeCy="-44.42556"
                          inkscapeDocument-units="mm"
                          inkscapeCurrent-layer="layer1"
                          showgrid="false"
                          inkscapeWindow-width="1366"
                          inkscapeWindow-height="745"
                          inkscapeWindow-x="-8"
                          inkscapeWindow-y="-8"
                        ...
                        <g
                          ...
                          <path
                            style={{fill:"#000000",strokeWidth:"0.97692311"}}
                ...
                <div>
                  <form className="main-form validate-form">
                    ...
                    <div className="container-main-form-btn">
                      ...
                      <div className="container-main-form-btn-MarkB dislike">
                        
                        <button className='main-form-btn-MarkB'
                                style={{backgroundColor: this.state.dislikeBtnColour}} 
                                onClick={this.checkDislike}>
                                <i className="fa fa-thumbs-o-down" style={{fontSize: "200%", color: "black"}}></i>
                        </button>

                      </div>

                      <div className="container-main-form-btn-MarkB">
                        
                        <button className='main-form-btn-MarkB'
                                style={{backgroundColor: this.state.likeBtnColour}} 
                                onClick={this.checkLike}>
                                  <i className="fa fa-thumbs-o-up" style={{fontSize: "200%", color: "black"}}></i>
                        </button>
