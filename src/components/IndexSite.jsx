...
window.React = React;
const companyPath = window.location.pathname; // returns /companyname/...
const companyName = companyPath.split('/').pop();
const companyLogo = `company-logo  ${companyName}`;
    ...
    <Row className="show-grid">
      ...
      <div className="background-image">
        <Col
          ...
          lg={6}
          lgPush={6}
          className="container-right-half modal-container"
        >
            ...
            <div className="main-form-header">
              ...
              <Row className="main-form-title">
                ...
                <Col xs={8}>
                  ...
                  >
                    Memnun kaldığın ve/yada kalmadığın bir şeyi yaz.
                  </h1>
                </Col>
              </Row>
            </div>
      ...
      >
        ...
        <Row className="show-grid">
          <Col
            ...
            md={12}
            lg={12}
            className="communication-item-left-group"
          >
            <div className="communication-item-left-wrapper">
              <div className="communication-item-left">
                <FontAwesome className="super-crazy-colors" name="users" />{' '}
                &nbsp; &nbsp;
              ...
              <div className="communication-item-left">
                <FontAwesome className="super-crazy-colors" name="search" />{' '}
                &nbsp; &nbsp;
                <span className="communication-item-text">
              ...
              <div className="communication-item-left">
                <FontAwesome className="super-crazy-colors" name="file" />{' '}
                &nbsp; &nbsp;
                <span className="communication-item-text">
          ...
          {/* communication-item-group  */}
        </Row>
        {/* communication-item-left-group */}
      </Col>
      {/* container-left-half */}
    </Row>
